      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <div className="flex items-center gap-4">
          <div className="text-sm text-slate-500 flex flex-col items-end">
            ...
            <span className="text-xs">Root Administrator</span>
          </div>
          <LogoutButton />
        </div>
      </header>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 flex flex-col">
            <h3 className="text-slate-500 font-medium text-sm mb-4">Total Users</h3>
            <div className="text-3xl font-bold text-slate-800">1</div>
            <div className="mt-4 text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full w-fit">
              +100% since launch
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 flex flex-col">
            ...
            <p className="mt-4 text-sm text-slate-500">PostgreSQL is running smoothly.</p>
          </div>

          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 flex flex-col">
            <h3 className="text-slate-500 font-medium text-sm mb-4">System Alerts</h3>
