    ...
    <>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-8">
        <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h2 className="text-2xl font-bold text-admin-text-primary">Serviços</h2>
            <p className="text-admin-text-muted mt-1">Gerencie os serviços do catálogo público.</p>
          </div>
          <div className="flex gap-2">
            <CategoryManager categories={categories} />
            <Link
              href="/admin/services/new"
              className="px-4 py-2 bg-admin-accent hover:bg-admin-accent-hover text-white font-medium rounded-lg shadow-sm transition-colors text-sm"
            >
              Novo Serviço
            </Link>
          </div>
