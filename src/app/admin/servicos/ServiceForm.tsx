    ...
    <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-3 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white min-h-[44px]"
        >
      ...
      >
        <div
          className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors shrink-0 ${
            form.isStartingPrice ? 'bg-indigo-600' : 'bg-slate-300'
          }`}
        >
        ...
        <span className="text-sm text-slate-700">Exibir como &quot;A partir de&quot;</span>
      </button>

      {/* Pet Size */}
      <div>
        <label className="block text-sm font-medium text-slate-700 mb-1.5">Porte do Pet</label>
